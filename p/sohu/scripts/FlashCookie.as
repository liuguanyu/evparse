		...
		private function doDataCheck() : void {
			...
			if(_loc1_ != null) {
				if(this.vSetID != -1) {
					...
					this.DataSaveSet(this.vSetID,null,this.vSessionID,null,-2,this.vPlayTime,this.vActCount,_loc1_[this.vSetID],-2,null,null,null);
				}
				_loc2_ = 0;
		...
		private function doDataSend(param1:int, param2:String) : void {
			...
			if(param1 != -1) {
				...
				if(_loc3_ != null) {
					...
					_loc4_ = _loc4_ + ("&_iwt_muid=" + encodeURI(_loc3_[11]));
					_loc4_ = _loc4_ + ("&r=" + int(Math.random() * 9999));
					if(_loc3_[8] < 2) {
						this.DataSaveSet(_loc3_[0],null,null,null,-2,-2,-2,-2,_loc3_[8] + 1,_loc3_[9],_loc3_[10],null);
					} else {
						this.DataSaveSet(_loc3_[0],null,null,null,-2,-2,-2,-2,_loc3_[8] + 1,_loc3_[9],_loc3_[10],_loc3_[11]);
			...
			if(this._IWT_Debug) {
				...
				while(_loc3_ < this._MaxSave) {
					...
					if(_loc2_ != null) {
						...
						this.vShareInfo = this.vShareInfo + ("FT_Data_" + _loc3_ + "[11]=" + _loc2_[11] + "\n");
					}
					_loc3_++;
				}
			} else {
