package com.alex.utils
{
   ...
   class GUID extends Object
   {
      ...
      static function create() : String
      {
         ...
         var _loc2_:Number = Math.random() * Number.MAX_VALUE;
         var _loc3_:String = Capabilities.serverString;
         var _loc4_:String = calculate(_loc1_ + _loc3_ + _loc2_ + counter++).toUpperCase();
         return _loc4_;
      }
