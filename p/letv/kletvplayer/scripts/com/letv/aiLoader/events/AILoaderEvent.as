package com.letv.aiLoader.events
{
   ...
   public class AILoaderEvent extends Event
   {
      ...
      public function AILoaderEvent(param1:String, param2:String = null, param3:int = 0, param4:int = 0, param5:Boolean = false, param6:Boolean = false)
      {
