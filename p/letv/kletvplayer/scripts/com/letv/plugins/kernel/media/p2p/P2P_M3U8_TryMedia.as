package com.letv.plugins.kernel.media.p2p
{
   ...
   public class P2P_M3U8_TryMedia extends BaseMedia
   {
      ...
      public function P2P_M3U8_TryMedia()
      {
         super();
      }
      ...
      public static function getInstance() : IMedia
      {
         if(_instance == null)
         {
            _instance = new P2P_M3U8_TryMedia();
         }
         return _instance;
      }
      ...
      {
         super.initBase(param1,PlayMode.P2P_M3U8_TRY);
      ...
      override public function seekTo(param1:Number, param2:Boolean = false) : void
      {
         ...
         try
         {
            ...
            else
            {
               ...
               gslburl = model.currentGslb.df;
               groupID = Sha1EncryptUtil.encrypt(gslburl);
               checkurl = "http://webchecksum.letv.com/" + gslburl.replace(".flv",".xml");
               obj = {
      ...
      override public function getLoadPercent() : Number
      {
         try
         {
            if(realDuration > 0)
            {
               return this.stream["bytesLoaded"] * realDuration / duration / this.stream["bytesTotal"];
            }
