...
{
   public class Sha1EncryptUtil extends Object
   {
      
      private static var charInputBit:uint;
      
      public function Sha1EncryptUtil(param1:Boolean)
      {
         super();
         if(param1)
         {
      ...
      private static function bin_to_hex(param1:Array) : String
      {
         ...
         {
            _loc4_ = _loc2_.charAt(param1[_loc5_ >> 2] >> (3 - _loc5_ % 4) * 8 + 4 & 15);
            _loc3_ = _loc3_ + (_loc4_ == "0"?"":_loc4_);
            _loc3_ = _loc3_ + _loc2_.charAt(param1[_loc5_ >> 2] >> (3 - _loc5_ % 4) * 8 & 15);
            _loc5_++;
         }
         return _loc3_;
      }
