package at.matthew.httpstreaming
{
   ...
   class HTTPStreamingMP2PESVideo extends HTTPStreamingMP2PESBase
   {
      ...
      function HTTPStreamingMP2PESVideo()
      {
         super();
         this._scState = 0;
      ...
      {
         var _loc5_:HTTPStreamingH264NALU = null;
         ...
         var _loc4_:Vector.<HTTPStreamingH264NALU> = new Vector.<HTTPStreamingH264NALU>();
         if(param3)
         {
            _loc5_ = new HTTPStreamingH264NALU(this._nalData);
            if(_loc5_.NALtype != 0)
            {
               _loc4_.push(_loc5_);
            }
         ...
         var _loc6_:HTTPStreamingH264NALU = null;
         var _loc7_:HTTPStreamingH264NALU = null;
