package at.matthew.httpstreaming
{
   ...
   class HTTPStreamingMP2PESAudio extends HTTPStreamingMP2PESBase
   {
      ...
      function HTTPStreamingMP2PESAudio()
      {
      ...
      override public function processES(param1:Boolean, param2:ByteArray, param3:Boolean = false) : ByteArray
      {
         ...
         if(param1)
         {
            ...
            else
            {
               ...
               if(_loc8_ != 2)
               {
                  throw new Error("No PTS in this audio PES packet" + _loc8_);
               }
               else
               {
