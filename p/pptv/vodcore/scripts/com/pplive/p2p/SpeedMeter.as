package com.pplive.p2p
{
	...
	public class SpeedMeter extends Object
	{
		...
		private static const RECENT_TIME_SCALE_IN_SECONDS:uint = 5;
		
		private static const MINUTE_TIME_SCALE_IN_SECONDS:uint = 60;
		...
		public function SpeedMeter(param1:uint = 60)
		{
			super();
		...
		public function get totalTimeInMS() : uint
		{
			...
			if(this._isRunning)
			{
				_loc1 = _loc1 + (getTimer() - this._startTime);
			}
			return _loc1;
		}
		...
		public function pause() : void
		{
			if(this._isRunning)
			{
				...
				this._totalTimeInMS = this._totalTimeInMS + (getTimer() - this._startTime);
			}
		}
		...
		{
			return this._totalBytes / this.totalTimeInMS;
		}
