package com.qiyi.player.wonder.body.model.remote
{
	...
	public class BonusRemote extends Object
	{
		...
		{
			var _loc6:* = "";
			_loc6 = SystemConfig.BONUS_API_URL + "?eventid=" + "view_video" + "&count=1" + "&pid=0" + "&cid=0" + "&uuid=" + param1 + "&tvid=" + param2 + "&channelid=" + param3 + "&vvsourceid=" + param5 + "&albumid=" + param4;
			this.startService(_loc6);
		}
		...
		{
			var _loc4:int = param1 / BodyDef.BONUS_DEFAULT_COUNT_ONCE;
			var _loc5:* = "";
			_loc5 = SystemConfig.BONUS_API_URL + "?eventid=" + "nologin_import" + "&count=" + _loc4 + "&pid=0" + "&cid=0" + "&vvsourceid=" + param3 + "&uuid=" + param2;
			this.startService(_loc5);
		}
