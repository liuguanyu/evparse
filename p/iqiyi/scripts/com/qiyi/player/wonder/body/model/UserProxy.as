	...
	public class UserProxy extends Proxy
	{
		...
		public function saveOneMinusBonus(param1:uint) : void
		{
			...
			if(!this._bonusCompleted)
			{
				if(this._isLogin)
				{
					_loc2 = (this._playerProxy.curActor.movieInfo) && !(this._playerProxy.curActor.movieInfo.infoJSON.sid == undefined)?this._playerProxy.curActor.movieInfo.infoJSON.sid:"";
					if(param1 > ConstUtils.MIN_2_MS)
					{
						this._bonusRemote.sendOneMinute(this._playerProxy.curActor.uuid,this._playerProxy.curActor.movieModel.tvid,this._playerProxy.curActor.movieModel.channelID,this._playerProxy.curActor.movieModel.albumId,_loc2);
		...
		public function savePlayOverBonus(param1:uint, param2:int) : void
		{
			...
			if(!this._bonusCompleted)
			{
				if(this._isLogin)
				{
					_loc3 = (this._playerProxy.curActor.movieInfo) && !(this._playerProxy.curActor.movieInfo.infoJSON.sid == undefined)?this._playerProxy.curActor.movieInfo.infoJSON.sid:"";
					if(param1 > ConstUtils.MIN_2_MS || param1 <= ConstUtils.MIN_2_MS && param2 <= ConstUtils.MIN_2_MS)
					{
						this._bonusRemote.sendPlayOver(this._playerProxy.curActor.uuid,this._playerProxy.curActor.movieModel.tvid,this._playerProxy.curActor.movieModel.channelID,this._playerProxy.curActor.movieModel.albumId,_loc3);
						this._bonusCompleted = true;
					}
				}
		...
		{
			var _loc3:String = (this._playerProxy.curActor.movieInfo) && !(this._playerProxy.curActor.movieInfo.infoJSON.sid == undefined)?this._playerProxy.curActor.movieInfo.infoJSON.sid:"";
			this._bonusRemote.sendSavedTotalBonus(param1,param2,_loc3);
		}
