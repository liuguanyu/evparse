	...
	public class RecommendView extends BasePanel
	{
		...
		public function onResize(param1:int, param2:int) : void
		{
			...
			if(isOnStage)
			{
				...
				{
					_loc3 = SwitchManager.getInstance().getStatus(SwitchDef.ID_SHOW_CONTROL_BAR_ISHIDE)?GlobalStage.stage.stageHeight:GlobalStage.stage.stageHeight - BodyDef.VIDEO_BOTTOM_RESERVE;
					this._boardRecommend.resize(param1,_loc3);
					this._boardRecommend.x = (param1 - this._boardRecommend.showWidth) / 2;
					this._boardRecommend.y = (_loc3 - this._boardRecommend.showHeight) / 2;
				}
			}
		}
