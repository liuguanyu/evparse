	...
	public class VolumeControlView extends Sprite
	{
		...
		public function updateVolumeControlView(param1:int, param2:Boolean = false, param3:Boolean = true) : void
		{
			...
			if(!param2)
			{
				...
				_loc4 = this._currentVolume / 100 * this._volumeControllerUI.volumePanel.volumeBar.width;
				this._volumeControllerUI.volumePanel.slider.x = _loc4;
				this._volumeControllerUI.volumePanel.volumeBar.mask.width = _loc4;
			...
			else
			{
				...
				{
					_loc4 = param1 / 100 * this._volumeControllerUI.volumePanel.volumeBar.width;
					this._volumeControllerUI.volumePanel.slider.x = _loc4;
					this._volumeControllerUI.volumePanel.volumeBar.mask.width = _loc4;
					this._volumeTip.text = param1 + "%";
					this._tipX = this._volumeControllerUI.volumePanel.x + this._volumeControllerUI.volumePanel.slider.x - this._volumeTip.width / 2;
		...
		{
			var _loc2:int = mouseX - this._volumeControllerUI.volumePanel.x;
			this.updateVolumeControlView(100 * _loc2 / this._volumeControllerUI.volumePanel.volumeBar.width);
		}
