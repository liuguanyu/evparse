	...
	public class ADView extends BasePanel
	{
		...
		public function onResize(param1:int, param2:int) : void
		{
			...
			if(this._adPlayer)
			{
				...
				_loc3.height = param2;
				_loc3.v_w = param1;
				_loc3.v_h = _loc3.height;
				this._adPlayer.dispatchEvent(new AdPlayerEvent(AdPlayerEvent.VIDEO_CHANGE_SIZE,_loc3));
			}
		}
		...
		{
			var _loc2:Object = {};
			_loc2.tvid = param1.data.tvId;
			_loc2.vid = param1.data.videoId;
			_loc2.version = param1.data.data;
			dispatchEvent(new ADEvent(ADEvent.Evt_LoadSuccess,_loc2));
		}
		...
		private function onAdLoadFailed(param1:AdPlayerEvent) : void
		{
			...
			_loc2.tvid = param1.data.tvId;
			_loc2.vid = param1.data.videoId;
			dispatchEvent(new ADEvent(ADEvent.Evt_LoadFailed,_loc2));
		}
		...
		private function onAdStartPlay(param1:AdPlayerEvent) : void
		{
			...
			_loc2.tvid = param1.data.tvId;
			_loc2.vid = param1.data.videoId;
			dispatchEvent(new ADEvent(ADEvent.Evt_StartPlay,_loc2));
		}
		...
		private function onAdAskVideoPause(param1:AdPlayerEvent) : void
		{
			...
			_loc2.tvid = param1.data.tvId;
			_loc2.vid = param1.data.videoId;
			dispatchEvent(new ADEvent(ADEvent.Evt_AskVideoPause,_loc2));
		}
		...
		private function onAdAskVideoResume(param1:AdPlayerEvent) : void
		{
			...
			_loc2.tvid = param1.data.tvId;
			_loc2.vid = param1.data.videoId;
			dispatchEvent(new ADEvent(ADEvent.Evt_AskVideoResume,_loc2));
		}
		...
		private function onAdAskVideoStartLoad(param1:AdPlayerEvent) : void
		{
			...
			_loc2.tvid = param1.data.tvId;
			_loc2.vid = param1.data.videoId;
			_loc2.delay = param1.data.data;
			dispatchEvent(new ADEvent(ADEvent.Evt_AskVideoStartLoad,_loc2));
		}
		...
		private function onAdAskVideoStartPlay(param1:AdPlayerEvent) : void
		{
			...
			if(param1.data.data)
			{
				_loc2.viewPoints = param1.data.data.viewPoints;
			}
			dispatchEvent(new ADEvent(ADEvent.Evt_AskVideoStartPlay,_loc2));
		}
		...
		private function onAdAskVideoEnd(param1:AdPlayerEvent) : void
		{
			...
			_loc2.tvid = param1.data.tvId;
			_loc2.vid = param1.data.videoId;
			dispatchEvent(new ADEvent(ADEvent.Evt_AskVideoEnd,_loc2));
		}
		...
		private function onAdBlock(param1:AdPlayerEvent) : void
		{
			...
			{
				_loc2.isCidErr = Boolean(param1.data.isCidErr);
			}
			else
			{
				_loc2.isCidErr = false;
			}
			dispatchEvent(new ADEvent(ADEvent.Evt_AdBlock,_loc2));
		}
