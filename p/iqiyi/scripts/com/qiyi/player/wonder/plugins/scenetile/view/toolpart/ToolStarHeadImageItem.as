package com.qiyi.player.wonder.plugins.scenetile.view.toolpart
{
	...
	public class ToolStarHeadImageItem extends Sprite
	{
		...
		private function init() : void
		{
			...
			var _loc1:BitmapData = null;
			if(this._headUrl)
			{
				_loc1 = BarrageStarHeadImage.instance.getHeadImageByUrl(this._headUrl);
			}
			if(_loc1)
			{
				this._starHeadImg.bitmapData = _loc1;
		...
		private function onHeadImgComplete(param1:Event) : void
		{
			...
			if(this._headUrl)
			{
				_loc2 = BarrageStarHeadImage.instance.getHeadImageByUrl(this._headUrl);
			}
			if(_loc2)
			{
