package com.qiyi.player.wonder.plugins.tips.model {
	...
	public class TipsProxy extends Proxy implements IStatus {
		...
		public function lagDownDefinition(param1:int) : Boolean {
			...
			this._definitionLagTimesArr.push(_loc2_);
			var _loc3_:* = 0;
			while(_loc3_ < this._definitionLagTimesArr.length) {
				if(_loc2_ - this._definitionLagTimesArr[_loc3_] > param1) {
					this._definitionLagTimesArr.splice(_loc3_,1);
				}
				_loc3_++;
			}
