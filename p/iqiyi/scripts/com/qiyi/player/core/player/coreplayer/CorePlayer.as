	...
	public class CorePlayer extends EventDispatcher implements ICorePlayer {
		...
		public function get movieInfo() : IMovieInfo {
			if(this._movieChecker) {
				return this._movieChecker.getMovieInfo();
			}
			return null;
		}
		...
		public function get loadComplete() : Boolean {
			var _loc1_:DMEngine = null;
			var _loc2_:* = 0;
			var _loc3_:* = 0;
			var _loc4_:* = 0;
			if((this._engine) && (this._movie)) {
				_loc1_ = this._engine as DMEngine;
				if((_loc1_) && (_loc1_.provider)) {
					return _loc1_.provider.loadComplete;
				}
				_loc2_ = this.bufferTime;
				if(_loc2_ > 0) {
					_loc3_ = this._runtimeData.endTime;
					if(_loc3_ == 0 && (this._runtimeData.skipTrailer)) {
						_loc3_ = this._movie.trailerTime;
					}
					_loc4_ = _loc3_ > 0?_loc3_:this._movie.duration;
					if(_loc2_ >= _loc4_ || _loc4_ - _loc2_ < 2000) {
						return true;
					}
				}
			}
		...
		public function sequenceReadDataFrom(param1:int) : MediaData {
			var _loc2_:DMEngine = null;
			if(this._engine) {
				_loc2_ = this._engine as DMEngine;
				if((_loc2_) && (_loc2_.provider)) {
					return _loc2_.provider.sequenceReadDataFrom(param1);
				}
			}
			return null;
		}
		...
		public function setADRemainTime(param1:int) : void {
			...
			if(this._engine) {
				_loc2_ = this._engine as DMEngine;
				if((_loc2_) && (_loc2_.provider)) {
					_loc2_.provider.setExpectTime(param1);
				}
			}
		}
		...
		private function createEngine() : void {
			...
			if(this._movie.streamType == StreamEnum.HTTP) {
				_loc1_ = Utility.getFlashVersion();
				if(_loc1_.ver1 > 10 || _loc1_.ver2 >= 1) {
		...
		private function installMovie() : void {
			var _loc1_:IMovie = this._movieChecker.getMovie();
			if((_loc1_) && !(this._movie == _loc1_)) {
				this._movie = _loc1_;
