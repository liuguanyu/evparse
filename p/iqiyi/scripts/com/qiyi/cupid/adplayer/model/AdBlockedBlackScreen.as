package com.qiyi.cupid.adplayer.model {
	...
	public class AdBlockedBlackScreen extends Sprite {
		...
		public static function isInBlacklist(param1:String) : Boolean {
			...
			var _loc2_:URLParser = new URLParser(param1);
			var _loc3_:String = _loc2_.getHost();
			return !(HOST_BLACKLIST.indexOf(_loc3_) == -1);
		}
		...
		private function onShowTimerComplete(param1:TimerEvent) : void {
			this.clearShowTimer();
			var _loc2_:AdBlockedBlackScreenEvent = new AdBlockedBlackScreenEvent(AdBlockedBlackScreenEvent.BLACK_SCREEN_COMPLETE);
