package com.statistics
{
   ...
   public class GUID extends Sprite
   {
      ...
      public static function create(param1:String = "") : String
      {
         var _loc2_:Date = new Date();
         var _loc3_:Number = _loc2_.getTime();
         var _loc4_:Number = Math.random() * Number.MAX_VALUE;
         var _loc5_:String = Capabilities.serverString;
         var _loc6_:String = calculate(_loc3_ + _loc5_ + _loc4_ + param1 + counter++).toUpperCase();
